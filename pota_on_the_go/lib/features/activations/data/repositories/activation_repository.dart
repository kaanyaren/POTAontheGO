...
final parkActivationsProvider =
    FutureProvider.family<List<ActivationModel>, String>((
      ref,
      reference,
    ) async {
...
class ActivationRepository {
  ...
  Future<List<ActivationModel>> getParkActivations(
    String reference, {
    int count = 10,
  }) async {
    try {
      final response = await _dio.get(
        'park/activations/$reference',
